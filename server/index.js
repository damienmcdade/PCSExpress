...
app.get('/api/market-stats', marketStatsRateLimit, async (req, res) => {
  ...
  const oconusHousing = isOconusMarket(state) ? {
    ...
    resources: [
      { name: 'DoD Overseas Housing Allowance (OHA) rates',                url: 'https://www.travel.dod.mil/Allowances/Overseas-Housing-Allowance/OHA-Rate-Lookup/',                          who: 'Military',                description: 'Official DTMO lookup for OHA rate, utility/recurring maintenance, and MIHA-Miscellaneous components at the gaining overseas locality.' },
