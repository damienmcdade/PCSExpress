...
const DEMO_STEPS = [
  ...
  },
  {
    ...
    description: 'Use official resume guidance and live employment resources during PCS transitions.',
    content: 'Review resume guidance and compare your experience to job announcements without uploading documents to the app.',
  ...
  },
  {
    ...
    description: 'Use official career resources to compare your resume against job announcement requirements.',
    content: 'The system provides:\n• Match percentage (0-100%)\n• Your key strengths\n• Skill gaps to address\n• Specific recommendations to improve\n\nOn web/Docker: Use official resume builder guidance\nOn iOS: Use official source sites for document steps',
    highlight: 'employment',
    action: null,
  },
  {
    ...
    description: 'Use official resume builder guidance to tailor your resume for each job announcement.',
