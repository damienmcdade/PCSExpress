...
const TEXT = {
  ...
  es: {
    ...
    subtitle: 'Apoyo laboral para cónyuges militares y miembros del servicio cerca de',
    languageNote: 'Esta vista usa el idioma elegido en el onboarding. Algunos nombres oficiales permanecen en inglés porque así los publica la fuente.',
    ...
    keywordHelp: 'Opcional. Deje en blanco para buscar puestos favorables para cónyuges militares.',
    keywordPlaceholder: 'gerente de proyecto, enfermería, ciberseguridad, remoto',
    open: 'Abrir',
    ...
    partner: 'Socio',
    business: 'Negocio',
    resourceText: 'Abra este recurso para ver orientación oficial y servicios disponibles actualizados.',
    externalText: 'Abra esta fuente externa solicitada para ver listados actuales y revise cada publicación antes de aplicar.',
    tabJobSearch: 'Búsqueda de empleo',
    tabJobResources: 'Recursos de empleo',
    tabResume: 'Ayuda con currículum',
    tabInternships: 'Pasantías',
    tabWorkshops: 'Talleres de empleo',
    tabCertifications: 'Certificaciones',
    tabMentorship: 'Mentoría',
    tabSpousePreferred: 'Preferencia para cónyuges',
    tabConnections: 'Conexiones',
    tabLinkedIn: 'Taller de LinkedIn',
    tabEntrepreneurship: 'Emprendimiento',
    leadJobSearch: 'Abra búsquedas activas adaptadas a la instalación de destino, sin tarjetas antiguas ni filtros que generan páginas vacías.',
    leadJobResources: 'Use portales oficiales, rutas para cónyuges militares y apoyo laboral gubernamental.',
    leadResume: 'Prepare un currículum federal con guías oficiales de USAJOBS y el Departamento de Trabajo.',
    leadInternships: 'Encuentre pasantías, becas, oportunidades para recién graduados y opciones remotas cuando estén disponibles.',
    leadWorkshops: 'Use clases gratuitas, coaching, eventos de contratación y talleres para cónyuges militares.',
    leadCertifications: 'Encuentre rutas de certificados gratuitas o financiadas para carreras portátiles.',
    leadMentorship: 'Conecte con programas de mentoría para currículum, entrevistas, networking y planificación.',
    leadSpousePreferred: 'Encuentre empleadores y rutas federales que apoyan la contratación de cónyuges militares.',
    ...
    leadEntrepreneurship: 'Explore capacitación oficial y gratuita para iniciar, crecer o reubicar un negocio.',
    resumeTipsTitle: 'Lista para currículum federal',
    tip1: 'Lea todo el anuncio antes de editar el currículum.',
    ...
    tip4: 'Siga las reglas de formato y páginas de USAJOBS.',
    tip5: 'No incluya SSN, información clasificada, CUI, fotos ni datos personales innecesarios.',
    linkedinStepsTitle: 'Flujo para buscar reclutadores',
    linkedinStep1: 'Busque el puesto y la ubicación, luego filtre por personas.',
    linkedinStep2: 'Use palabras como recruiter, talent acquisition y hiring manager.',
    linkedinStep3: 'Compare empresas con socios MSEP o programas para cónyuges.',
    linkedinStep4: 'Envíe un mensaje corto con el puesto, la ubicación, la fecha de PCS y una habilidad relevante.',
  },
  de: {},
  fr: {},
  ko: {},
