...
<style>
  ...
  <div class="stamp">
    Generated by PCS Express. Worksheet contains text only — no photos. Submit alongside DD 1840R via the DPS damage-claim portal (dps.move.mil): report loss/damage within 180 days of delivery and file the itemized claim within 9 months for full replacement value. Keep any supporting photos in your own files; PCS Express does not store, transmit, or accept images.
  </div>
</body></html>`;
}
