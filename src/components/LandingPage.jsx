...
const SECURITY_POINTS = [
  ...
  { title: 'What does leave the device (always disclosed in-app)', body: 'AI Assistant and free-text Translate (both off until you explicitly agree, and you can withdraw any time under Security & data handling): your typed question or text + a non-PII context blob (branch / rank / component / phase / open-task count) to Anthropic (Claude), or to OpenAI when Anthropic is unavailable. Navigation: addresses you type, to OpenStreetMap (Nominatim + OSRM). Local resource lookups (business directory, jobs, housing rates, market stats, schools, family activities): your gaining installation’s city / state / ZIP (and any address you type) go to the relevant public APIs — SAM.gov, USASpending.gov, USAJOBS, FRED, and HUD. Translation widget (opt-in): translated page contents to Google. Advertising: none is currently served; if enabled in future it will be consent-gated and default to non-personalized.' },
