        ...
        <div style={{ background: '#FFF3E0', border: '1.5px solid #FFB74D', borderRadius: 14, padding: 16, marginBottom: 14 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 8 }}>
            {[
              ...
              { name: 'DSSR §240 — TQSA',                        url: 'https://allowances.state.gov/Default.asp',         who: 'DoD Civilian', desc: 'Temporary Quarters Subsistence Allowance — up to 90 days of overseas temporary lodging while you search for permanent quarters.' },
