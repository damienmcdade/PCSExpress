  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <div style={{ display: 'grid', gap: 8 }}>
        ...
        <a href="https://www.gsa.gov/policy-regulations/regulations/federal-travel-regulation-ftr" target="_blank" rel="noopener noreferrer" className="card-cta card-cta--block card-cta--ghost">Federal Travel Regulation (FTR) — civilians</a>
