...
export default function MedicalReadinessTab({ theme, profile }) {
  ...
  const RES_BUNDLE = {
    ...
    behavioral: [
      ...
      { name: 'DoD Behavioral Health Resources', desc: 'Behavioral health resources for service members and dependents across all branches (DHA / Military Health System).', url: 'https://www.health.mil/Military-Health-Topics/Mental-Health', source: 'health.mil' },
    ...
    readiness: isCivilian
      ? [
          { name: 'OPM Wellness Programs', desc: 'Worksite wellness, biometric screenings, and Federal Occupational Health resources for civilian employees.', url: 'https://www.opm.gov/policy-data-oversight/worklife/', source: 'OPM.gov', badge: 'CIVILIAN' },
      ...
      : [
          { name: 'Periodic Health Assessment (PHA)', desc: 'Annual readiness physical exam. Required for active duty and most Reserve/Guard. Documented in MHS GENESIS.', url: 'https://www.health.mil/Military-Health-Topics/Health-Readiness', source: 'health.mil', badge: 'PHA' },
  ...
  const RESOURCES = {
    ...
    spiritual: [
      { _section: 'Chaplaincy & Pastoral Care', items: [
        ...
        { name: 'MTF Pastoral Care', desc: 'Most military treatment facilities have a Pastoral Care office that coordinates chaplain visits for inpatients, surgery candidates, and family members during critical or end-of-life care. Ask the MTF charge nurse to contact Pastoral Care.', url: 'https://www.health.mil/Military-Health-Topics/Mental-Health', source: 'health.mil', badge: 'MTF' },
    ...
    fitness: [
      { _section: 'On-Base Gym & Fitness Facilities', items: [
        ...
        { name: 'Army H2F (Holistic Health & Fitness) Centers', desc: 'Army Holistic Health and Fitness facilities at brigade combat teams — strength, conditioning, nutrition coaching, performance physical therapy.', url: 'https://www.google.com/search?q=Army+H2F+holistic+health+fitness+site%3Aarmy.mil', source: 'army.mil' },
      ...
      { _section: 'Staying Fit During PCS Travel', items: [
        { name: 'Military OneSource — Fitness & Health', desc: 'Official Military OneSource health and fitness toolkit. Includes packable workout routines, mental-health connection between exercise and resilience, and travel-day fitness tips.', url: 'https://www.militaryonesource.mil/health-wellness/', source: 'militaryonesource.mil', badge: 'FREE' },
        ...
        { name: 'Hotel-room workout routines', desc: 'Bodyweight circuits you can do in a 6 ft × 6 ft space: 100 burpees, 5×20 push-ups, 5×30-second planks, walking lunges, hip bridges. No equipment, 20–30 minutes. Maintains baseline conditioning through a 10–14-day TLE / TLA stay.', url: 'https://www.google.com/search?q=Army+resilience+fitness+site%3Aarmyresilience.army.mil', source: 'armyfit.com' },
        { name: 'PCS travel days — movement basics', desc: 'Get up every 90 minutes on long drives or flights to walk, stretch hips and calves, and hydrate. Sleep deprivation + sitting + dehydration on a PCS week is the most common combination behind soft-tissue injuries during in-processing PT.', url: 'https://www.health.mil/Military-Health-Topics', source: 'health.mil' },
      ]},
      { _section: 'Diet & Meal Tips for Traveling', items: [
        ...
        { name: 'TRICARE Nutrition Counseling', desc: 'TRICARE-covered medical nutrition therapy with a Registered Dietitian, available before, during, and after the PCS for diabetes, weight management, and high cholesterol.', url: 'https://www.tricare.mil/CoveredServices', source: 'tricare.mil', badge: isCivilian ? 'REFERENCE' : 'TRICARE' },
        { name: 'Cooler & cold-pack meal planning for the drive', desc: 'Pre-pack hard-boiled eggs, nut butter sandwiches, fruit, carrots, hummus, and refillable water bottles for the first 24–48 hours of POV travel. Avoids the gas-station calorie spiral that derails fitness scores in the weeks after PCS.', url: 'https://www.militaryonesource.mil/health-wellness/healthy-eating/', source: 'militaryonesource.mil' },
