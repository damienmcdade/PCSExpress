    ...
    <div className="tab-content">
      ...
      {activeTab === 'career' && (() => {
        ...
        const cards = civilian ? [
          ...
          { title: 'OPM HR University',                            desc: 'Centralized federal HR training portal run by the Office of Personnel Management — free courses for federal civilians on hiring, classification, payroll, and leadership.', url: 'https://www.opm.gov' },
          { title: 'DCPAS Civilian Career Development',            desc: 'DoD Civilian Personnel Advisory Service career-development guidance: career programs, leadership development, mentoring, IDP templates.', url: 'https://www.google.com/search?q=DCPAS+career+management+site%3Adcpas.osd.mil' },
