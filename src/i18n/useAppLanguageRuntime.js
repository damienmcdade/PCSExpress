...
const PHRASES = {
  ...
  'Federal': tr('Federal', 'Bund', 'Fédéral', '연방', '連邦', 'Pederal', 'فدرالي', '联邦', 'Federale', 'Federal', 'Liên bang'),
  ...
  'Certification': tr('Certificación', 'Zertifikat', 'Certification', '자격증', '認定', 'Sertipikasyon', 'شهادة', '证书', 'Certificazione', 'Certificação', 'Chứng chỉ'),
  ...
  'Certifications': tr('Certificaciones', 'Zertifikate', 'Certifications', '자격증', '認定', 'Mga Sertipikasyon', 'الشهادات', '证书', 'Certificazioni', 'Certificações', 'Chứng chỉ'),
  ...
  'Counseling': tr('Consejería', 'Beratung', 'Conseil', '상담', 'カウンセリング', 'Pagpapayo', 'استشارة', '咨询', 'Consulenza', 'Aconselhamento', 'Tư vấn'),
  ...
  'Reserve': tr('Reserva', 'Reserve', 'Réserve', '예비군', '予備役', 'Reserba', 'الاحتياط', '预备役', 'Riserva', 'Reserva', 'Dự bị'),
  ...
  'Monthly BAH': tr('BAH mensual', 'Monatliche BAH', 'BAH mensuel', '월간 BAH', '月額BAH', 'Buwanang BAH', 'BAH الشهري', '月度 BAH', 'BAH mensile', 'BAH mensal', 'BAH hằng tháng'),
  'Months': tr('Meses', 'Monate', 'Mois', '개월', 'ヶ月', 'Buwan', 'أشهر', '个月', 'Mesi', 'Meses', 'Tháng'),
  'Annual BAH': tr('BAH anual', 'Jährliche BAH', 'BAH annuel', '연간 BAH', '年額BAH', 'Taunang BAH', 'BAH السنوي', '年度 BAH', 'BAH annuale', 'BAH anual', 'BAH hằng năm'),
  ...
  'Dependents': tr('Dependientes', 'Angehörige', 'Personnes à charge', '부양가족', '扶養家族', 'Mga Dependent', 'التابعون', '家属', 'Familiari a carico', 'Dependentes', 'Người phụ thuộc'),
  ...
  'Military Family Verified': tr('Verificado por familia militar', 'Militärfamilie verifiziert', 'Famille militaire vérifiée', '군 가족 인증', '軍人家族認証済み', 'Beripikadong Pamilyang Militar', 'تم التحقق من عائلة عسكرية', '军人家庭已认证', 'Famiglia militare verificata', 'Família militar verificada', 'Đã xác minh gia đình quân nhân'),
