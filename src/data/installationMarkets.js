...
export const INSTALLATION_MARKETS = {
  ...
  // OCONUS installations: replaced military mail routing (APO/FPO/AE/AP)
  // with real geographic city, country, and local postal code. APO/FPO
  // codes are not geocodable — Nominatim resolves "APO, AE" to random
  // places (Turkey, Philippines, Finland). Public city/country/postal
  // data only, sourced from official installation pages on .mil sites.
  'USAG Stuttgart':       { city: 'Stuttgart',         state: 'Germany',     zip: '70569' },
  'USAG Wiesbaden':       { city: 'Wiesbaden',         state: 'Germany',     zip: '65189' },
  'USAG Bavaria':         { city: 'Vilseck',           state: 'Germany',     zip: '92249' },
  'USAG Ansbach':         { city: 'Ansbach',           state: 'Germany',     zip: '91522' },
  'USAG Italy Vicenza':   { city: 'Vicenza',           state: 'Italy',       zip: '36100' },
  'Camp Bondsteel':       { city: 'Ferizaj',           state: 'Kosovo',      zip: '70000' },
  'Naval Station Rota':   { city: 'Rota',              state: 'Spain',       zip: '11520' },
  'Spangdahlem AB':       { city: 'Spangdahlem',       state: 'Germany',     zip: '54529' },
  'Incirlik AB':          { city: 'Incirlik',          state: 'Turkey',      zip: '01710' },
  'Aviano AB':            { city: 'Aviano',            state: 'Italy',       zip: '33081' },
  'Lajes Field':          { city: 'Praia da Vitória',  state: 'Portugal',    zip: '9760' },
  'RAF Lakenheath':       { city: 'Lakenheath',        state: 'United Kingdom', zip: 'IP27 9PN' },
  'RAF Mildenhall':       { city: 'Mildenhall',        state: 'United Kingdom', zip: 'IP28 8NF' },
  'RAF Alconbury':        { city: 'Alconbury',         state: 'United Kingdom', zip: 'PE28 4DA' },
  'Al Udeid AB':          { city: 'Doha',              state: 'Qatar',       zip: '' },
  'Al Dhafra AB':         { city: 'Abu Dhabi',         state: 'United Arab Emirates', zip: '' },
  'Misawa AB':            { city: 'Misawa',            state: 'Japan',       zip: '033-0022' },
  'MCAS Iwakuni':         { city: 'Iwakuni',           state: 'Japan',       zip: '740-0021' },
  'Camp Foster':          { city: 'Ginowan',           state: 'Japan',       zip: '901-2225' },
  'Osan AB':              { city: 'Pyeongtaek',        state: 'South Korea', zip: '17914' },
  'Kunsan AB':            { city: 'Gunsan',            state: 'South Korea', zip: '54002' },
  'Naval Station Guam':   { city: 'Santa Rita',        state: 'Guam',        zip: '96915' },
  'Andersen AFB':         { city: 'Yigo',              state: 'Guam',        zip: '96929' },
