...
export const INSTALLATION_MARKETS = {
  ...
  'Lajes Field':          { city: 'Praia da Vitória',  state: 'Portugal',    zip: '' },
  ...
  'Camp Butler (Okinawa)': { city: 'Okinawa', state: 'Japan', zip: '' },
  'Camp Kinser': { city: 'Urasoe', state: 'Japan', zip: '' },
  'Camp Courtney': { city: 'Uruma', state: 'Japan', zip: '' },
  'Camp Hansen': { city: 'Kin', state: 'Japan', zip: '' },
  'Camp Schwab': { city: 'Nago', state: 'Japan', zip: '' },
  'MCAS Futenma': { city: 'Ginowan', state: 'Japan', zip: '' },
