...
export const MILITARY_DUTY_STATIONS = [
  ...
  // 2025 SECDEF restoration: original (current) name listed first; the 2023
  // Naming Commission name is kept selectable as the former name.
  ...
  { name: 'Fort Pickett',                            state: 'VA', branch: 'Army' },
  { name: 'Fort Barfoot',                            state: 'VA', branch: 'Army' },
  { name: 'Fort A.P. Hill',                          state: 'VA', branch: 'Army' },
  { name: 'Fort Walker',                             state: 'VA', branch: 'Army' },
  ...
  { name: 'USCG Sector Lake Michigan',               state: 'WI', branch: 'Coast Guard' },
  ...
  { name: 'USCG Sector Ohio Valley',                 state: 'KY', branch: 'Coast Guard' },
  ...
  { name: 'USCG Sector Southeast New England',       state: 'MA', branch: 'Coast Guard' },
