...
function ResourcesTab({ theme, profile }) {
  ...
  const RESOURCES = {
    healthcare: [
      ...
      { name: 'TRICARE Online', desc: 'Book appointments, view records, refill prescriptions', url: '', tag: 'All Branches' },
      { name: 'TRICARE 4U', desc: 'TRICARE beneficiary portal — claims, EOBs, and coverage details', url: '', tag: 'All Branches' },
      { name: 'TRICARE for Life (TFL)', desc: 'Medicare-wraparound coverage for retired service members via TRICARE4u', url: '', tag: 'Retirees' },
      ...
      { name: 'TRICARE Overseas', desc: 'TRICARE coverage for beneficiaries stationed or living outside the U.S.', url: '', tag: 'OCONUS' },
      { name: 'TRICARE Overseas Program (TOP)', desc: 'Managed care option for overseas military beneficiaries', url: '', tag: 'OCONUS' },
      ...
      { name: 'Humana Military (HMS) — TRICARE', desc: 'TRICARE East Region managed care — find providers and manage benefits', url: '', tag: 'All Branches' },
      { name: 'My MHS GENESIS', desc: 'Military Health System patient portal — records, appointments, secure messaging', url: '', tag: 'All Branches' },
    ...
    financial: [
      ...
      { name: 'Military Saves', desc: 'Financial readiness resources, savings plans, and debt reduction tools', url: '', tag: 'All Branches' },
    ...
    pcs: [
      ...
      { name: 'SCRA Lease Termination', desc: 'Break your lease when PCS orders arrive — federal protection', url: '', tag: 'PCS' },
    ...
    education: [
      ...
      { name: 'MyCAA Scholarships', desc: 'Up to $4,000/year for military spouses pursuing portable careers', url: '', tag: 'Spouses' },
      ...
      { name: 'DoDEA Schools', desc: 'Find DoD-operated schools for military families worldwide', url: '', tag: 'Families' },
    ],
    careers: [
      ...
      { name: 'MyCAA — Spouse Career Advancement Accounts', desc: 'Up to $4,000/year in scholarships for military spouses pursuing portable careers', url: '', tag: 'Spouses' },
    ...
    portals: [
      ...
      { name: 'milConnect (DMDC)', desc: 'Defense Manpower Data Center — view benefits, DEERS updates, and personnel data', url: '', tag: 'All Branches' },
    ],
  };
...
function VAHomeLoanPanel({ theme, profile }) {
  ...
  const lenders = [
    { name: 'VA Lender Search', url: 'https://www.benefits.va.gov/homeloans/lenders.asp', note: 'Official VA lender information and program guidance.' },
    { name: 'Navy Federal Credit Union', url: '', note: 'Military-focused mortgage products and VA loan education.' },
    { name: 'USAA Mortgage', url: '', note: 'Military community lender with PCS-aware mortgage resources.' },
    { name: 'Veterans United', url: '', note: 'VA-loan education and nationwide military homebuyer support.' },
  ];
  return (
    <div>
      <div style={{ background: theme.secondary, borderRadius: 12, padding: 14, marginBottom: 14, borderLeft: `3px solid ${theme.accent}` }}>
