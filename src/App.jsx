...
function App() {
  ...
  const DEMO_TIPS = [
    ...
    { tab: 'home', title: 'Onboarding - Bases & Unit',
      body: 'The losing installation, gaining installation, departing date, and actual gaining unit power most of the app. They shape the PCS checklist timeline, base map, school and childcare lookup, job-search location, unit information, OCONUS indicators, route planning, and document reminders. Unit selection is for real military unit names only; details come from public unit profiles or official/public lookup links.' },
    { tab: 'home', title: 'Onboarding - Family & Preferences',
      body: 'Family & Preferences captures whether dependents are traveling, child ages, and optional faith preference. Child ages help surface school, childcare, and youth-transition resources; dependent travel affects document and PCS planning prompts; faith preference filters chapel and counseling resources without storing private pastoral information.' },
    { tab: 'home', title: 'Home - Category Selector',
      body: 'Home is the command center after onboarding. The category selector mirrors the app navigation in alphabetical order: Checklist, Deployment, Documents, Education, EFMP, Employment, Faith, Home Relocation, Move Aid, Navigation, Orders, Permanent Resident, Pets, Resources, Schools, Translate, Unit Info, and Veterans.' },
    { tab: 'checklist', title: 'Checklist - PCS Phase Tracker',
      body: 'Checklist turns PCS requirements into a phase-based tracker from orders through in-processing. It uses the departure date and profile details to keep required actions visible and saves progress locally for offline or comms-dark use.' },
    { tab: 'checklist', title: 'Checklist - Phase Sections',
      body: 'Checklist sections follow the move timeline: Orders Received, 90 Days Out, 60 Days Out, 30 Days Out, Move Week, and In-Processing. Each task helps users track orders, finance, household goods, lodging, medical, school, travel, arrival, and local installation requirements.' },
    { tab: 'spouse', title: 'Deployment - Family Support Guide',
      body: 'Deployment helps families prepare for separation periods by organizing support tasks that often matter before, during, or after a PCS-adjacent deployment. It is built for spouses and family members who need a practical readiness path.' },
    { tab: 'spouse', title: 'Deployment - Readiness Tabs',
      body: 'Deployment content covers legal and financial readiness, mental health and resilience, family and children planning, household management, emergency contacts, childcare, school support, TRICARE, military legal assistance, and family-support links.' },
    { tab: 'documents', title: 'Documents - PCS Records',
      body: 'Documents gives users a secure local checklist for the records needed during a move. It helps organize what to gather without uploading documents to PCS Express servers, and it reminds users to keep restricted, controlled, or non-public government information out of the app.' },
    { tab: 'documents', title: 'Documents - Checklist Tabs',
      body: 'Document tabs include Orders, Travel & Finance, Household Goods, Housing, Medical, Family & Admin, OCONUS, EFMP-related records, and branch-specific forms. These tabs help the user prepare packets for finance, transportation, medical, housing, schools, and travel offices.' },
    { tab: 'education', title: 'Education - Benefits & School Planning',
      body: 'Education explains official education benefits and school-planning resources for service members, spouses, and families. It helps users understand benefit categories and find schools near the gaining installation.' },
    { tab: 'education', title: 'Education - Benefit Tabs',
      body: 'Education tabs include GI Bill Chapters, How to Apply, Colleges, Find Schools, and MyCAA for spouses. These sections guide users toward VA benefit research, college comparison, local school searches, spouse funding, and official application paths.' },
    { tab: 'efmp', title: 'EFMP - Branch-Tailored PCS Support',
      body: 'EFMP helps families understand branch-specific Exceptional Family Member Program requirements during PCS planning. It supports assignment coordination, medical and education screening, gaining-location coordination, and official EFMP resources.' },
    { tab: 'efmp', title: 'EFMP - PCS Checklist Tabs',
      body: 'EFMP sections guide users through before-orders preparation, orders received, medical and education screening, gaining-location coordination, arrival actions, branch start points, and official support links for Army, Navy, Marine Corps, Air Force, Space Force, and Coast Guard families.' },
    { tab: 'employment', title: 'Employment - Career Center',
      body: 'Employment helps service members and spouses turn location, skills, and military-family hiring programs into practical job-search actions near the gaining installation or remote market.' },
    { tab: 'employment', title: 'Employment - Job Search',
      body: 'Job Search focuses on real opportunity paths instead of repeating the resource library. It creates base-specific searches for LinkedIn, Indeed, ClearanceJobs, and USAJOBS, highlights remote indicators, and prioritizes military-spouse supportive terms and hiring paths where relevant.' },
    { tab: 'employment', title: 'Employment - Career Tabs',
      body: 'Employment tabs include Skills Profile, Job Search, Recommendations, Resume, and Job Resources. Skills Profile stores experience locally, Recommendations suggests career matches, Resume supports careful resume handling, and Job Resources links to official or spouse-supportive programs such as MySECO, MSEP, USAJOBS, Hire Heroes USA, and Hiring Our Heroes.' },
    { tab: 'religion', title: 'Faith - Chaplain & Community Support',
      body: 'Faith uses the optional onboarding preference to surface chapel services, counseling, and community support. It is designed to show public support resources while avoiding sensitive pastoral notes or private religious details.' },
    { tab: 'religion', title: 'Faith - Support Tabs',
      body: 'Faith tabs include Services and Counseling. Services points users toward installation chapel and worship resources; Counseling highlights chaplain, Military OneSource, MFLC, and other support pathways that may help during relocation stress.' },
    { tab: 'home-relocation', title: 'Home Relocation - Inventory & Claims',
      body: 'Home Relocation helps users document household goods before and after delivery, track claim windows, and estimate replacement value. It is built around practical evidence gathering for loss or damage during a PCS move.' },
    { tab: 'home-relocation', title: 'Home Relocation - Claims Tabs',
      body: 'Home Relocation sections include Digital Inventory & Evidence, Claims Deadline Management, Replacement Value Calculator, DPS links, and moving-claims resources. The 180-day loss/damage notice and 9-month full replacement value reminders help users preserve claim rights.' },
    { tab: 'moving-assistance', title: 'Move Aid - Financial Assistance',
      body: 'Move Aid educates users on resources that can reduce the financial strain of moving. It clearly marks GRANT, FREE ASSISTANCE, and LAND / HOUSING resources so users can quickly separate emergency relief, counseling, entitlement education, and housing support.' },
    { tab: 'moving-assistance', title: 'Move Aid - Resource Types',
      body: 'Move Aid includes branch relief societies, Military OneSource financial counseling, Operation Homefront, Dislocation Allowance and PCS travel entitlements, SCRA lease and housing protections, VA housing assistance, and other official or public assistance links.' },
    { tab: 'nav', title: 'Navigation - Routes & Public Base Map',
      body: 'Navigation helps plan travel and understand public installation services. It uses only public, non-restricted base information and avoids restricted areas, force-protection details, internal layouts, internal entry procedures, and mission data.' },
    { tab: 'nav', title: 'Navigation - Map Tabs',
      body: 'Navigation tabs include Route Planner, Directions, Saved Routes, and Base Map. Base Map focuses on public-facing points such as visitor control, gates, hospitals, commissary, exchange, chapel, housing office, education center, childcare, legal assistance, and recreation where official public information is available.' },
    { tab: 'orders', title: 'Orders - PCS Data Entry',
      body: 'Orders helps capture report date, branch, losing base, gaining base, gaining unit, dependent travel, and OCONUS indicators so the rest of the app can tailor checklists and resources. Users should enter only the minimum information needed and avoid restricted, controlled, or sensitive mission details.' },
    { tab: 'orders', title: 'Orders - Local Handling',
      body: 'Orders supports upload review and manual correction, but extracted text is handled locally for profile updates. The purpose is to reduce repetitive typing while keeping document content off PCS Express servers and within the user-controlled device environment.' },
    { tab: 'immigration', title: 'Permanent Resident - USCIS Support',
      body: 'Permanent Resident organizes official USCIS and military legal-help information for military families handling immigration questions during a PCS. It is informational and directs users to official resources for case-specific decisions.' },
    { tab: 'immigration', title: 'Permanent Resident - Immigration Tabs',
      body: 'Permanent Resident tabs include Green Card, Citizenship, Military Legal Help, and Checklist. These sections explain common USCIS pathways, military-family naturalization support, legal assistance options, and PCS-aware documentation tasks.' },
    { tab: 'pet-relocation', title: 'Pets - Relocation Checklist',
      body: 'Pets helps users prepare animals for PCS travel with a checklist similar to PCS documentation flows. It covers vet records, microchip and vaccine checks, airline or AMC planning, lodging, import rules, and eligible expense documentation.' },
    { tab: 'pet-relocation', title: 'Pets - Official Resource Areas',
      body: 'Pet sections guide users through records, health certificates, USDA APHIS steps, airline or AMC requirements, OCONUS country rules, crate preparation, lodging, reimbursement documentation, and active official/public resource links.' },
    { tab: 'resources', title: 'Resources - Official Source Hub',
      body: 'Resources gives users one place to reach official and public support sites instead of hunting through separate portals. It is organized for quick reference during a move, deployment, career change, education search, or family support need.' },
    { tab: 'resources', title: 'Resources - Support Tabs',
      body: 'Resource sections include Healthcare, Military Portals, Family Support, Financial, PCS & Housing, Education, Careers, immigration/legal support, emergency assistance, and related official/public links such as TRICARE, Military OneSource, VA, DFAS, DPS, and USAJOBS.' },
    { tab: 'schools', title: 'Schools - Childcare & Education',
      body: 'Schools uses the gaining installation and child ages from onboarding to surface education and childcare planning resources. It helps families find school liaison support, DoDEA or local district options, childcare search paths, and school transition resources.' },
    { tab: 'schools', title: 'Schools - Planning Tabs',
      body: 'Schools sections include K-12 Schools, Daycare & CDC, school liaison support, DoDEA or local district lookup, and Find Schools links for custom gaining locations. The goal is to help families start official school and childcare research early.' },
    { tab: 'translation', title: 'Translate - Language Support',
      body: 'Translate supports families in housing, school, medical, emergency, transportation, shopping, and daily-life conversations during CONUS or OCONUS moves. Preferred language from onboarding sets the default translation experience.' },
    { tab: 'translation', title: 'Translate - Phrase Tabs',
      body: 'Translate tabs include Translate, Common Phrases, and Saved. Phrase categories cover Emergency & Safety, Housing & Landlord, Shopping & Daily Life, Medical & Pharmacy, School & Childcare, and Transportation.' },
    { tab: 'unit-info', title: 'Unit Info - Public Unit Profile',
      body: 'Unit Info uses the branch, gaining installation, and actual unit from onboarding to display public unit information only. It must not contain rosters, internal contact lists, schedules, deployment details, controlled government information, restricted information, or non-public mission data.' },
    { tab: 'unit-info', title: 'Unit Info - Unit Tabs',
      body: 'Unit Info tabs include Overview, Unit History, Unit Connection, and Public Lookup. Unit Connection combines official contact pathways and public social media lookup; Public Lookup helps users verify details through official .mil, .gov, public affairs, DVIDS, and other public sources.' },
    { tab: 'veterans', title: 'Veterans - Veteran-Owned Businesses',
      body: 'Veterans helps users find veteran-owned business resources and directories near the gaining installation. It supports families who want to connect with local veteran communities or find public business directories after a move.' },
